...
let squash repo public_branch_str old_commit = 
  Scylla_kvStore.Branch.get repo public_branch_str >>= fun latest_cmt ->
  ...
  Scylla_kvStore.of_branch repo public_branch_str >>= fun private_branch_anchor ->
